...
results_fullpath = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'results', model_name)#model_name
...
configs_det.use_labels_as_objects = False #False #  = use groundtruth labels as objects, False = use model-based detection
configs_det.save_results = False # Save results on file (based on data file name)
...
# exec_detection = []
# exec_detection = ['bev_from_pcl', 'detect_objects', 'validate_object_labels', 'measure_detection_performance'] #'bev_from_pcl', 'detect_objects', 'validate_object_labels', 'measure_detection_performance'] # options are 'bev_from_pcl', 'detect_objects', 'validate_object_labels', 'measure_detection_performance']
exec_detection = ['bev_from_pcl'] #'bev_from_pcl', 'detect_objects', 'validate_object_labels', 'measure_detection_performance']#'bev_from_pcl', 'detect_objects', 'validate_object_labels', 'measure_detection_performance'] # options are 'bev_from_pcl', 'detect_objects', 'validate_object_labels', 'measure_detection_performance'; options not in the list will be loaded from file
